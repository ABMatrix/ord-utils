...
exports.inscribeWithOneStep = exports.inscribe = exports.createSendRunes = exports.createSendMultiBTC = exports.createSendMultiOrds = exports.createSendOrd = exports.createSendBTC = void 0;
...
function createSendBTC({ utxos, toAddress, toAmount, wallet, network, changeAddress, receiverToPayFee, feeRate, dump, data, txInfo, }) {
...
function createSendOrd({ utxos, toAddress, toOrdId, wallet, network, changeAddress, feeRate, outputValue, dump, data, txInfo, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
function createSendMultiOrds({ utxos, toAddress, toOrdIds, receivers, wallet, network, changeAddress, feeRate, dump, data, txInfo, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
function createSendMultiBTC({ utxos, receivers, wallet, network, changeAddress, feeRate, dump, data, txInfo, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
function createSendRunes({ utxos, receivers, wallet, network, changeAddress, feeRate, dump, data, runestone, txInfo, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
exports.createSendRunes = createSendRunes;
function inscribe({ address, utxos, inscription, wallet, network, feeRate, changeAddress, dump, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function inscribeWithOneStep({ address, utxos, inscription, wallet, network, pubkey, feeRate, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        psbt.addOutput({ value: OrdUnspendOutput_1.UTXO_DUST, address });
        yield psbt.signAllInputsAsync(wallet.signer);
