...
exports.inscribeWithOneStep = exports.inscribe = exports.createSendRunes = exports.calculateMaxBtc = exports.createSendMaxBTC = exports.createSendMultiBTC = exports.createSendMultiOrds = exports.createSendOrd = exports.createSendBTC = exports.initWasm = void 0;
...
const rng = __importStar(require("randombytes"));
const bip32_1 = __importDefault(require("bip32"));
var ord_utils_tiny_secp256k1_2 = require("ord-utils-tiny-secp256k1");
Object.defineProperty(exports, "initWasm", { enumerable: true, get: function () { return ord_utils_tiny_secp256k1_2.initWasm; } });
...
function createSendOrd({ utxos, toAddress, toOrdId, wallet, network, changeAddress, feeRate, outputValue, dump, data, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
function createSendRunes({ utxos, receivers, wallet, network, changeAddress, feeRate, dump, data, runestone, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
