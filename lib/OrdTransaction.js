        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.inputs.length; i++) {
                ...
                if (v.utxo.addressType === AddressType.P2PKH) {
                    const txApiUrl = `https://mempool.space${this.network.bech32 === bitcoin.networks.bitcoin.bech32
                        ? ""
            ...
            const res = yield this.wallet.signPsbt(psbt.toBuffer().toString("hex"), txInfo);
