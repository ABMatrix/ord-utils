...
exports.inscribe = exports.createSendMultiBTC = exports.createSendMultiOrds = exports.createSendOrd = exports.createSendBTC = exports.initWasm = void 0;
...
function createSendBTC({ utxos, toAddress, toAmount, wallet, network, changeAddress, receiverToPayFee, feeRate, pubkey, dump, data, }) {
...
function createSendOrd({ utxos, toAddress, toOrdId, wallet, network, changeAddress, pubkey, feeRate, outputValue, dump, data, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, pubkey, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
function createSendMultiOrds({ utxos, toAddress, toOrdIds, receivers, wallet, network, changeAddress, pubkey, feeRate, dump, data, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, pubkey, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
...
function createSendMultiBTC({ utxos, receivers, wallet, network, changeAddress, feeRate, pubkey, dump, data, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const tx = new OrdTransaction_1.OrdTransaction(wallet, network, pubkey, feeRate);
        yield tx.initBitcoin();
        tx.setChangeAddress(changeAddress);
